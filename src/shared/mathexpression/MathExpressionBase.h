...
protected:
  ...
  public:
    ...
    void add( const string & name, const P & value, const string & description=L"" )
      { push_back( new ConstValueNodeFactoryImpl(name,(T)value,description));
      }
  ...
  public:
    ...
    void add( const string & name, int arg_index, const string & description=L"" )
      { push_back( new ArgNodeFactoryImpl(name,arg_index,description));
      }
  ...
  public:
    ...
    void add( const string & name, const P * pointer_to_value, const string & description=L"" )
      { push_back( new BoundParameterNodeFactoryImpl<P>(name,pointer_to_value, description));
      }
  ...
  public:
    ...
    void add( const string & name, const string & description=L"" )
      { push_back( new typename mybase::template FunctionNodeFactory<F,fn>(name,description) );
      }
    template<int numargs,class F>
    void add( const string & name, const F & f, const string & description=L"" )
      { push_back( new typename mybase::template FunctorNodeFactory<F,numargs>(name,f,description) );
      }
    template<class F>
    void add( const string & name, F * f, const string & description=L"" )
      { push_back( new typename mybase::template FunctionPointerNodeFactory<F*>(name,f,description) );
      }
    template<class R>
    void add( const string & name, const MathExpressionBase<R> * f, const string & description=L"" )
      { push_back( new typename mybase::template MathExpressionNodeFactory<R>(name,f,description) );
      }
    };
  ...
  public:
    ...
    void add( const string & operator_string, R (*pointer_to_operator_function)(T), const string & description=L"" )
      { push_back( new typename mybase::template FunctionPointerNodeFactory<R(*)(T)>(operator_string,pointer_to_operator_function,description) );
      }
    template<class R>
    void add( const string & operator_string, R (*pointer_to_operator_function)(const T&), const string & description=L"" )
      { push_back( new typename mybase::template FunctionPointerNodeFactory<R(*)(const T&)>(operator_string,pointer_to_operator_function,description) );
      }
    template<class R, class P >
    void add( const string & operator_string, R (*pointer_to_operator_function)(P), const string & description=L"" )
      { push_back( new typename mybase::template FunctionPointerNodeFactory<R(*)(P)>(operator_string,pointer_to_operator_function,description) );
      }
    ...
    template<class F>
    void add( const string & name, const F & f, const string & description=L""  )
      { push_back( new typename mybase::template FunctorNodeFactory<F,1>(name,f,description) );
      }

#ifndef _MSC_VER
    template<T (*fn)(T) >
    void add( const string & name, const string & description=L""  )
      { push_back( new typename mybase::template FunctionNodeFactory<T(*)(T),fn>(name,description) );
      }

    template<T (*fn)(const T &) >
    void add( const string & name, const string & description=L""  )
      { push_back( new typename mybase::template FunctionNodeFactory<T(*)(const T&),fn>(name,description) );
      }

    template<const T (*fn)(const T &) >
    void add( const string & name, const string & description=L""  )
      { push_back( new typename mybase::template FunctionNodeFactory<const T(*)(const T&),fn>(name,description) );
      }
#endif
  ...
  public:
    ...
    public:
      ...
      void add( const string & operator_string, R (*pointer_to_operator_function)(const T&,const T&), const string & description=L"" )
        { push_back( new typename mybase::template FunctionPointerNodeFactory<R(*)(const T&,const T&)>(operator_string,pointer_to_operator_function,description) );
        }
      template<class R, class P1, class P2 >
      void add( const string & operator_string, R (*pointer_to_operator_function)(P1,P2), const string & description=L"" )
        { push_back( new typename mybase::template FunctionPointerNodeFactory<R(*)(P1,P2)>(operator_string,pointer_to_operator_function,description) );
        }
      ...
      template<class F>
      void add( const string & name, const F & f, const string & description=L""  )
        { push_back( new typename mybase::template FunctorNodeFactory<F,2>(name,f,description) );
        }

#ifndef _MSC_VER
      template<T (*fn)(T,T) >
      void add( const string & name, const string & description=L"" )
        { push_back( new typename mybase::template FunctionNodeFactory<T(*)(T,T),fn>(name,description) );
        }

      template<T (*fn)(const T &, const T &) >
      void add( const string & name, const string & description=L""  )
        { push_back( new typename mybase::template FunctionNodeFactory<T(*)(const T&,const T&),fn>(name,description) );
        }

      template<const T (*fn)(const T &, const T &) >
      void add( const string & name, const string & description=L""  )
        { push_back( new typename mybase::template FunctionNodeFactory<const T(*)(const T&,const T &),fn>(name,description) );
        }

      template<bool (*fn)(T,T) >
      void add( const string & name, const string & description=L"" )
        { push_back( new typename mybase::template FunctionNodeFactory<bool(*)(T,T),fn>(name,description) );
        }

      template<bool (*fn)(const T &, const T &) >
      void add( const string & name, const string & description=L""  )
        { push_back( new typename mybase::template FunctionNodeFactory<bool(*)(const T&,const T&),fn>(name,description) );
        }
#endif
      };
  ...
  *ppNode = 0;
  ...
  if( (af = Arguments.find_by_name(name)) )
  ...
  else if( (ff = Functions.find_by_name(name)) )
    {
      ...
      else if( ( numargs!=VARARG && args.size() != numargs) )
        { success = false;
#ifdef USE_DEFAULT_ERROR
