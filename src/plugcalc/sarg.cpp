...
SArg operator+(const SArg & op1, const SArg & op2)
{
	...
	case SA_INT64:  return op1.arg.v_int64 + (__int64)op2;
    ...
    case SA_UINT64: return op1.arg.v_uint64 + (unsigned __int64)op2;
...
SArg SArg::Ror(const SArg & op) const
{
	...
	{
    case SA_INT64:  
		return (__int64)((_int64)(arg.v_int64>>sh) | (_int64)(arg.v_int64<<sh2));
    case SA_UINT64:
		return (unsigned __int64)((unsigned __int64)(arg.v_uint64>>sh) | (unsigned __int64)(arg.v_uint64<<sh2));
    case SA_INT: 
...
SArg SArg::Rol(const SArg & op) const
{
	...
	{
    case SA_INT64:  
		return (__int64)((__int64)(arg.v_int64<<sh) | (__int64)(sh2 ? arg.v_int64>>sh2 : 0));
    case SA_UINT64:
		return (unsigned __int64)((unsigned __int64)(arg.v_uint64<<sh) | (unsigned __int64)(sh2 ? arg.v_uint64>>sh2 : 0));
    case SA_INT: 
...
{
  return (int)(signed long long int)*this;
};
SArg::operator short() const
{
  return (short)(signed long long int)*this;
};
SArg::operator char() const
{
  return (char)(signed long long int)*this;
};

SArg::operator unsigned __int64() const
{
	switch(type)
	{
    case SA_BIG: { BigInt d; v_big.ToInt(d); unsigned long long int res; d.ToInt(res); return res; }
...
{
  return (unsigned int)(unsigned long long int)*this;
};
SArg::operator unsigned short() const
{
  return (unsigned short)(unsigned long long int)*this;
};
SArg::operator unsigned char() const
{
  return (unsigned char)(unsigned long long int)*this;
};
...
{
	unsigned __int64 data, data_mask;
...
SArg SArg::_d2b(const SArg & op1)
{
	...
	unsigned __int64 *i = (unsigned __int64 *)&df;
	return SArg(*i);
}
...
{
	/// \WARNING! hardware-dependent!
	unsigned __int64 i = (unsigned __int64)op1;
	double *df = (double *)&i;
	return SArg(*df);
}
